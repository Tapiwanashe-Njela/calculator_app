    ...
    def button_click(self):
        ...
        if text == "=":
            ...
            try: #The try block lets you test a block of code for errors.
                ...
                self.text_box.setText("Result: " + str(result)) #If eval passes we display the value of result in our textbox after we convert it to a string
...
#current --> https://youtu.be/f_9NBdSAo-g?t=6470